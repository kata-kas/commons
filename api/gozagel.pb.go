...
var file_api_gozagel_proto_rawDesc = []byte{
	...
	,
...
var file_api_gozagel_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_api_gozagel_proto_goTypes = []any{
	(*User)(nil),                  // 0: api.User
	(*AuthResponse)(nil),          // 1: api.AuthResponse
	(*QuoteRequestsBody)(nil),     // 2: api.QuoteRequestsBody
	(*Quote)(nil),                 // 3: api.Quote
	(*QuoteRequestsResponse)(nil), // 4: api.QuoteRequestsResponse
	(*QuotesResponse)(nil),        // 5: api.QuotesResponse
}
var file_api_gozagel_proto_depIdxs = []int32{
	3, // 0: api.QuotesResponse.quotes:type_name -> api.Quote
	0, // 1: api.AuthService.Login:input_type -> api.User
	0, // 2: api.AuthService.Register:input_type -> api.User
	2, // 3: api.QuoteRequestsService.RequestQuotes:input_type -> api.QuoteRequestsBody
	4, // 4: api.QuoteRequestsService.GetQuotes:input_type -> api.QuoteRequestsResponse
	1, // 5: api.AuthService.Login:output_type -> api.AuthResponse
	1, // 6: api.AuthService.Register:output_type -> api.AuthResponse
	4, // 7: api.QuoteRequestsService.RequestQuotes:output_type -> api.QuoteRequestsResponse
	5, // 8: api.QuoteRequestsService.GetQuotes:output_type -> api.QuotesResponse
